...
class RadiologyChecklistGenerator:
    ...
    def generate_checklist(self, case_metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        system_prompt = """You are an expert radiologist creating a comprehensive checklist for imaging study interpretation. 
    ...
    def save_checklist(self, checklist: Dict[str, Any], case_id: str) -> str:
        ...
        try:
            filename = f"checklist_{case_id}.json"
...
class InteractiveQASystem:
    ...
    def generate_follow_up_questions(self, question_data: Dict[str, Any], details: str) -> List[str]:
        ...
        system_prompt = """You are an expert radiologist. When a finding is identified, generate 2-3 specific follow-up questions to gather more detailed information about the finding.
        Focus on location, size, characteristics, and clinical significance."""
        
        human_prompt = f"""
        Finding identified: {question_data['item']}
        Category: {question_data['category']} > {question_data['subcategory']}
